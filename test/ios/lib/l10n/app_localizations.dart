...
abstract class AppLocalizations {
  ...
  /// No description provided for @trustedTagline.
  ///
  /// In en, this message translates to:
  /// **'Trusted Healthcare at your Doorstep'**
  String get trustedTagline;
  ...
  /// No description provided for @aboutGHC.
  ///
  /// In en, this message translates to:
  /// **'About Grace Health Care'**
  String get aboutGHC;
  ...
  /// No description provided for @ghcPatient.
  ///
  /// In en, this message translates to:
  /// **'GHC Patient'**
  String get ghcPatient;
